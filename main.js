...
body.addEventListener("keydown", (e) => {
    e.preventDefault()
    console.log(e.keyCode,e.location,key_codes.indexOf(e.keyCode),current[key_codes.indexOf(e.keyCode)]);
    text.focus()
    if(char_keys.includes(e.keyCode)){
        buttons[key_codes.indexOf(e.keyCode)].classList.add("active")
        var cursor = text.selectionEnd
        text.value = text.value.substr(0,text.selectionEnd)+current[key_codes.indexOf(e.keyCode)]+text.value.substr(text.selectionEnd)
  ...
  body.addEventListener("keyup", (e) => {
    if(char_keys.includes(e.keyCode)){
        buttons[key_codes.indexOf(e.keyCode)].classList.remove("active")
      }else{
        ...
        if(e.keyCode==17||e.key=="Ctrl"&&e.location==1)buttons[55].classList.remove("active")
        if(e.keyCode==17||e.key=="Ctrl"&&e.location==2)buttons[63].classList.remove("active")
